...
from DBwithFlaskPackage.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
from DBwithFlaskPackage.models import User, Post
from DBwithFlaskPackage import app, db, bcrypt, mail
...
{url_for('reset_token', token = token, _externals = True)}

If you did not make this request then simply ignore this email and no changes will be made.
'''		#	'_externals = True' means we will use absolute full URL
	mail.send(msg)
