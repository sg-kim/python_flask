...
from DBwithFlaskPackage import db, bcrypt 
from DBwithFlaskPackage.models import User, Post
from DBwithFlaskPackage.users.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm
from DBwithFlaskPackage.users.utils import save_picture, send_reset_email
